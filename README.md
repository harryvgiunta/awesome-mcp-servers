...
- 🧩 [JSON Contracts](https://github.com/json-contracts/json-contracts) - Local MCP server for natural-language-to-JSON workflows using Git-controlled JSON contracts and JSON Schema validation. Install with `npx -y json-contracts@latest`.
