...
- 🧩 [JSON Contracts](https://github.com/json-contracts/json-contracts) - Local MCP server for Git-controlled JSON contracts, JSON Schema validation, and structured LLM/agent outputs. Install with `npx -y json-contracts@latest`.
